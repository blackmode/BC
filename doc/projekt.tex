...
\projectinfo{
  ...
  title.en={Web browser of panoramic images}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
...
\keywords[en]{WebGL, HTML5, javascript, panorama, spherical video, browser}
