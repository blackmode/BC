...
Objektová proměnná \texttt{SETTINGS} uchovává informace o nastavení modu programu resp. formát dat, které bude program vyobrazovat. Dále informace pro nastavení a inicializaci grafických prvků.


\section{Běh programu}
Před samotným spuštěním programu je ještě nutné provést některé inicializační operace, nastavení a ověření. Jednou ze zásadních problémů testování je podpora prohlížečů, kterou musíme ověřit nejdříve.
