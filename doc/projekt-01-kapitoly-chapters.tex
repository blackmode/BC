...
Následující souřadnici \texttt{y} vyjádříme obdobným vztahem jako u předchozí souřadnice:
...
Opět máme v rovnici proměnnou \texttt{K}, kterou ale máme již vypočtenou ve vztahu \ref{math:K}, tudíž už jen tento vztah dosadíme a vznikne rovnice pro souřadnici \texttt{y}:
...
Poslední souřadnice \texttt{z} je značně jednodušší, protože nám odpadá proměnná \texttt{K}. Výsledný vtah je tedy možné vyjádřit následovně:
...
\begin{figure}[h]
	\label{img:3}
	\centering
	\includegraphics[scale=1.0,angle=0,width=0.65\linewidth]{obrazky-figures/vertex}
	\caption{Aproximovaná koule}
	\label{fig:geom2}
\end{figure}
