...
Veškeré interakce s myší se z hlediska datové částí promítají do objektové proměnné \texttt{MOUSE}, která udržuje data o pohybu pozorovatele ve scéně po vertikální a horizontální ose otáčení, včetně hloubky posuvu - tedy přibližování scény pomocí kolečka. Drtivá většina udržovaných dat v proměnné \texttt{MOUSE} pochází z Javascriptové metody \texttt{addEventListener()}.
Dalším objektem je klávesnice realizována pomocí objektové proměnné \texttt{KEYBOARD}, která udržuje pouze základní informace, zdali je aktivní popř. jaká citlivost pohybu pozorovatele ve scéně pomocí klávesnice má být. Veškeré interakce s klávesnici jsou dále realizovány pomocí události \texttt{event}, do které se načítají údaje o stisku kláves, tudíž není třeba další data uchovávat. 

Před samotným spuštěním programu je ještě nutné provést některé inicializační operace
