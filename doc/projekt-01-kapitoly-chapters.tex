...
\begin{figure}[h]
	...
	\centering
	\includegraphics[scale=1.0,angle=0,width=0.4\linewidth]{obrazky-figures/perspective_matrix}
...
Pro testování byl využit jednoduchý nástroj frameworku \texttt{three.js}, který refektuje aktuální počet snímků za sekundu tj.  rychlost překreslování scény grafickou kartou.
