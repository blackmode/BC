...
Zásadní vylepšení by mohlo přijít spolu s novou verzí WebGL, která  disponuje širší škálou funkcionality a otevírá nové možnosti, jak program vylepšit a optimalizovat. Zejména by tato funkcionalita mohla vyřešit problém švu, který vzniká v režimu rybího oka při spojení hemisfér. Jedná se o problém, který se za stávající specifikace WebGL nepovedlo vyřešit, nýbrž pouze zmenšit jeho dopad na přijatelnou úroveň. Díky tomuto problému bylo taktéž odpovězeno na otázku, proč výrobce používá konvertor.  Projekt jako takový má velký potenciál, jak již bylo uvedeno v úvodu práce, protože v současné době je trendem  rozšiřování možnosti prohlížení. Dalším vylepšením by mohla být širší podpora zařízení, jako např. ty, které disponují více kamerami, aby pokryly lépe celou sféru. Zde by byla velice zajímaví implementace, kdy  by si musela poradit s více záběry a mapovat je na jeden sférický model.

Některé nápady na další vylepšení programu již bohužel nebyla naplněna
Cíle zadání práce se tedy podařilo naplnit, bohužel některá řešení a možnosti zlepšení, které jsem dostal zrealizuji až nad rámec práce, což by mohlo velice zpříjemnit prohlížení.
 
 


Osnova:\\
1.) co bylo cilem a co jsem udelal, co se povedlo, a zdali jsem plsplnil zadani\\
2.) co by se dalo udelat dal, jako vylepseni apod\\
3.) zminit, zena tom budu pracovat dal, protoze me to zacalo bavit a zvazuju i koupi kamery
