...
\draw (orig) ellipse (\r/2.55 and  \r);

%\draw (0,0) circle (2);

% Axes
\draw[->] (orig) -- ++(-\r/2.67,-\r/3.25) node[below] (x1) {$x_1$};
...
\draw [shift={(0,0)}, lightgray, fill, fill opacity=0.1] (0,0) -- (-142.7:0.4) arc (-142.7:-33.2:0.4) -- cycle;
