...
\subsection{Plátno}
Jak již bylo avizováno výše, plátno, neboli element <canvas> slouží v HTML5 pro vykreslení grafů. herní grafiky, obrázů bitmap apod. Díky elementu <canvas> lze vykreslovat i náročnější grafické věcí pomocí WebGl. 
