...
Po získání objektu plátna lze dále s elementem manipulovat pomocí dvou metod:
	 	\begin{itemize}		
			...
			\item \texttt{getContext(contextId[, ... ])}\newline
			 - metoda vrací referenci na daný objekt aplikačního rozhraní, díky kterému bude možné kreslit na plátno. Typ aplikačního rozhraní je vybrán na základě argumentu metody:
			 \begin{itemize}
			 	\item  \texttt{\textbf{2d}} description 		 	
			 	\item \texttt{\textbf{webgl}} description
			 \end{itemize}
