...
\subsection{Plátno}
Jak již bylo avizováno výše, plátno, neboli element <canvas> slouží v HTML5 pro vykreslení grafů. herní grafiky, obrázů bitmap apod. Díky elementu <canvas> lze vykreslovat i náročnější grafické objekty zapomocí WebGl. V HTML5 slouží tedy především k vykreslení 2D prvků pomocí Javascriptu.
