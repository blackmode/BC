...
\subsection{Atributy}
Stejně jako data matic se musí i data bufferů propojit se shadery. To se provede funkcí \texttt{getAttribLocation()}, která vrací referenci na atribut. Reference atributu bodu geometrie se načte   do globální proměnné \texttt{PROG.attributes.vertex}, pro mapování textury do obdobné proměnné \texttt{PROG.attributes.texture}.
