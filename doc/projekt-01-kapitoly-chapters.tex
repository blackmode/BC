...
\begin{description}
	...
	\item[\texttt{varying}] 
	- tento datový typ slouží k předávání hodnot z vertex shaderu do fragment shaderu. \cite{WebGLbeg} Pomocí něj se provádí výše avizovaná interpolace viz. obr. \ref{img:1}.
