...
Ovládací prvky videa jsou vytvářeny pomocí DOM a přidávány do kostry HTML. Celá kostra s atributem \texttt{id=viewer} obsahuje i plátno, které překrývají \texttt{<canvas>}. Při změně velikosti plátna musíme pozice prvků vždy přepočítat. Veškeré operace nad ovládacími prvky zastřešuje funkce \createVideoControlls. Jedním ze vstupních argumentů je objekt videa, důvodem je ten, že nad objektem funguje celá řada událostí.
