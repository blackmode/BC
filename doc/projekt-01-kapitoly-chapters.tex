...
\section{Kompas}
Prvek překrývající plátno \texttt{<canvas>}. Vstupnímí metadaty jsou zadány koordinační body severu, popř. jihu. Díky interakcí s myší - tedy násobení zobrazovací transformační maticí realizujeme pohyb pozorovatele, čímž se mění prostorové souřadnice, které ovlivňují odchylku severu, popř. jihu od původní zadané pozice v metadatech.

\subsection{Pozicování}
Vytvoření samotného komapsu realizuje funkce \texttt{createCompass(width, height)}
