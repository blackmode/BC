...
S korekcí se mapuje textura daleko přesněji, resp. okraje hemisféry.
...
Je-li definována souřadnice \textit{\textbf{y}} z rovnice \ref{math:y} a souřadnice \textit{\textbf{z}} rovnicí \ref{math:z} , tak korekce textury bude definována tak, že souřadnice vynásobíme funkcí \textit{\textbf{arccos(y)}}. Každá hemisféra koule bude mít odlišnou modifikaci souřadnice \texttt{\textbf{x}}, resp. výpočet každé hemisféry probíhá v jiném kvadrantu kartézské soustavy souřadnic, jinak bychom nemohli mapovat obě sféry, spojily by se nám do jedné tj. body by se překrývaly - důvod je zřejmý, data z kterých korekce vychází jsou počítány pro celou kouli a nerespektováním změny souřadnice, by se bod zobrazil až   ``za'' vyobrazeným bodem na obrazovce. \\
...
\begin{itemize}
	\item Pro levou hemisféru bude platit následující vztah:\\
		    $$u =  x \cdot \arccos(y) \wedge v =  z \cdot \arccos(y)$$   

	\item Pro pravou hemisféru bude platit vztah:\\
			$$u =  -x \cdot \arccos(y) \wedge v =  z \cdot \arccos(y) $$ 
