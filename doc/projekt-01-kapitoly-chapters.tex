...
Hlavní rozdíl mezi funkcemi je ten, že \texttt{drawArrays()} vykresluje přímo data geometrie tak,  jak byla spočítána a vložena do vertex bufferu. Samotné body prostoru, tak jak jsou definovány, jsou uvedeny vícekrát pro každé sousedící primitivum.
...
Průměrné naměřené hodnoty\footnote{Během vývoje programu s běžnou zátěží.}:

\begin{center}
	\begin{tabular}{ l | c  } 
		
		Frekvence snímků videa & 46 fps   \\ 
 		\hline
		Frekvence snímků panoramatu & 57 fps   \\ 
		\hline
		Doba načtení jednoho snímku  & 17 ms \\ 
 		\hline
		Využití paměti & 12  MB   \\ 
		
	\end{tabular}
\end{center}

Výkonnostní srovnání přehrávání videa napříč prohlížeči:

\begin{center}
	\begin{tabular}{ l | c| c| c  } 
		& Firefox & Opera  & Chrome   \\ 
 		\hline
		Frekvence snímků videa & 39 fps & 19 fps & 60 fps    \\ 
		\hline
		Doba načtení jednoho snímku  & 25 ms & 52 ms & 17 ms  \\ 
		\hline
		Využití paměti & 12  MB & 12  MB & 12  MB   \\ 
...
\section{náměty vycházející ze zkušeností s řešeným projektem}
